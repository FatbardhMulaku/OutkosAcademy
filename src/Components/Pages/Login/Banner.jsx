      ...
      <div className="login__banner-content">
        <Fade top big>
          <h1 className="sub-title">
            <FormattedMessage
              id="login.title.1"
              defaultMessage="What do we offer"
            />
          </h1>
        </Fade>
        <Fade left cascade>
        <div className="offers">
          <article className="single-offer">
            ...
            <div className="text">
              <h3 className="paragraph-1">
                <FormattedMessage
                  id="login.item.title.1"
                  defaultMessage="Quality"
                />
              </h3>
              <p className="paragraph-3">
                <FormattedMessage
                  id="login.item.desc.1"
          ...
          <article className="single-offer">
            ...
            <div className="text">
              <h3 className="paragraph-1">
                <FormattedMessage
                  id="login.item.title.2"
                  defaultMessage="Variety"
                />
              </h3>
              <p className="paragraph-3">
                <FormattedMessage
                  id="login.item.desc.2"
                  defaultMessage="We offer a huge number of different Courses you can select for your own preferences"
                />
              </p>
            </div>
          </article>
          <article className="single-offer">
            ...
            <div className="text">
              <h3 className="paragraph-1">
                <FormattedMessage
                  id="login.item.title.3"
                  defaultMessage="Certified Teachers"
                />
              </h3>
              <p className="paragraph-3">
                <FormattedMessage
                  id="login.item.desc.3"
                  defaultMessage="The Teachers here are all professionals at their Courses and do this as a Daily Job."
                />
              </p>
            </div>
          </article>
