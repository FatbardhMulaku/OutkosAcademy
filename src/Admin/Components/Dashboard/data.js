...
export const studentsUp = [
  {
    name: (
      <FormattedMessage
        id="GraphicDesign.studentsUp.1"
        defaultMessage="Bardhi"
      />
    ),
  },
  {
    name: (
      <FormattedMessage
        id="GraphicDesign.studentsUp.2"
        defaultMessage="Fisnik"
      />
    ),
  },
];
...
export const studentsDown = [
  {
    name: (
      <FormattedMessage
        id="GraphicDesign.studentsDown.1"
        defaultMessage="Drilon"
      />
    ),
  },
  {
    name: (
      <FormattedMessage
        id="GraphicDesign.studentsDown.2"
        defaultMessage="Filloreta"
      />
    ),
  },
  {
    name: (
      <FormattedMessage
        id="GraphicDesign.studentsDown.3"
        defaultMessage="Zana"
      />
    ),
  },
...
export const NewApplications = [
  {
    name: "Endrit Gashi",
    desc:
      "Hello Bleart, I am a Beginner Designer looking forward to learn more about design as it is my main career focus. Thanks in Advance.",
    btn1: "Accept",
    btn2: "Deny",
    btn3: "Ask a Question",
  },
